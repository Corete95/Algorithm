...
ex)   k=3   score=[10, 100, 20, 150, 1, 100, 200]                  result=[10, 10, 10, 20, 20, 100, 100]
      k=4   score=[0, 300, 40, 300, 20, 70, 150, 50, 500, 1000]    result=[0, 0, 0, 0, 20, 40, 70, 70, 150, 300]
...
function solution(k, score) {
  ...
  for (let i = 0; i < score.length; i++) {
    ...
    if (answer.length >= k && k <= i) {
      score[i] > answer[0] ? (answer[0] = score[i]) : answer;
      result.push(answer.sort((a, b) => a - b)[0]);
    }
  }
  return result;
